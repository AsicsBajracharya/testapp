    ...
    <>
      <div className="card">
        ...
        <div className="card-body">
          <div className="row">
            <div className="col-md-4">
              <div className="input-wrapper">
                <label htmlFor="guardian-name_of_guardian">Name of Nominee*</label>
                <div className="input-group">
                  <input onChange={(e) => dispatch({ type: "inputChange", value: e.target.value, field: "nameOfGuardian" })} onBlur={(e) => dispatch({ type: "inputBlur", value: e.target.value, field: "nameOfGuardian" })} type="text" id="guardian-name_of_guardian" className="form-control" placeholder="Nominee's Full Name" required />
                </div>
          ...
          <h4>Nominee's Current Address</h4>
          <div className="row">
            <div className="col-md-4">
              <div className="input-wrapper">
          ...
          <h4>Nominee's Permanent Address</h4>
          <div className="row">
            <div className="col-md-4">
              <div className="input-wrapper">
                <label htmlFor="address-country">Country*</label>
